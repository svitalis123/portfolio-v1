...
import { a as Avatar, i as CardHeader, n as CardContent, o as AvatarFallback, r as CardFooter, t as Card } from "./card_DMkLjadk.mjs";
import { useEffect, useRef, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowDown, ChevronRight } from "lucide-react";
import { MongoClient } from "mongodb";
import { AnimatePresence, motion, useMotionValue, useTransform } from "framer-motion";
//#region src/components/homepage/components/HeroPage.jsx
var roles = [
	"Software Engineer",
...
var HeroSection = () => {
	...
	const images = ["/shared/vitalis4.webp", "/shared/vitalis3.webp"];
	useEffect(() => {
	...
	const floatingX = useTransform(mouseX, (v) => v * .5);
	const floatingY = useTransform(mouseY, (v) => v * .5);
	const stagger = {
		hidden: { opacity: 0 },
		visible: {
			opacity: 1,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			[...Array(6)].map((_, i) => /* @__PURE__ */ jsx(motion.div, {
					...
					children: [/* @__PURE__ */ jsxs(motion.div, {
						...
						children: [
							/* @__PURE__ */ jsxs(motion.div, {
								...
								children: [/* @__PURE__ */ jsx("div", { className: "w-12 h-px bg-[#e34b3a]" }), /* @__PURE__ */ jsx("span", {
									className: "text-sm tracking-[0.3em] uppercase text-[#e34b3a] font-medium",
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs(motion.h1, {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: nameTop.split("").map((char, i) => /* @__PURE__ */ jsx(motion.span, {
											custom: i,
										...
										className: "block overflow-hidden",
										children: nameBottom.split("").map((char, i) => /* @__PURE__ */ jsx(motion.span, {
											custom: i + 7,
											variants: letterReveal,
											initial: "hidden",
											animate: "visible",
							...
							/* @__PURE__ */ jsx(motion.div, {
								...
								children: /* @__PURE__ */ jsx(AnimatePresence, {
									...
									children: /* @__PURE__ */ jsxs(motion.div, {
										...
										children: [/* @__PURE__ */ jsx("span", {
											className: "text-[#e34b3a] text-xl font-mono",
											children: "//"
										}), /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsx(motion.div, {
								...
								children: roles.map((_, i) => /* @__PURE__ */ jsx("button", {
									onClick: () => setActiveRole(i),
									className: "group flex items-center",
									children: /* @__PURE__ */ jsx("div", { className: `h-[2px] rounded-full transition-all duration-500 ${i === activeRole ? "w-8 bg-[#e34b3a]" : "w-3 bg-[#ecc7bc] opacity-30 group-hover:opacity-60"}` })
								}, i))
							}),
							...
							/* @__PURE__ */ jsxs(motion.div, {
								...
								children: [/* @__PURE__ */ jsxs(motion.a, {
									...
									whileHover: { scale: 1.03 },
									whileTap: { scale: .97 },
									children: ["View Projects", /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4 group-hover:translate-x-1 transition-transform" })]
								})]
							})
						]
					}), /* @__PURE__ */ jsx(motion.div, {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx(motion.div, {
											...
											children: /* @__PURE__ */ jsxs("div", {
												className: "flex items-center gap-3",
												children: [/* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-green-400 animate-pulse" }), /* @__PURE__ */ jsx("span", {
													className: "text-sm text-[#ecc7bc] font-medium",
								...
								/* @__PURE__ */ jsx(motion.div, {
									...
									children: [
										...
										children: [/* @__PURE__ */ jsx("div", {
											className: "text-2xl font-bold text-[#e34b3a]",
											children: stat.value
										}), /* @__PURE__ */ jsx("div", {
											className: "text-xs uppercase tracking-wider opacity-50 mt-1",
											children: stat.label
										})]
									}, i))
								})
...
//#endregion
//#region src/components/homepage/components/FeaturedProjects.jsx
var Whiteboard = () => /* @__PURE__ */ jsxs(motion.svg, {
...
var KanbanBoard = () => /* @__PURE__ */ jsxs(motion.svg, {
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 120 80",
...
var TriangularRuler = () => /* @__PURE__ */ jsxs(motion.svg, {
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 100 87",
...
var ProjectSection = ({ project }) => {
	return /* @__PURE__ */ jsx("main", {
		className: "panel w-screen h-screen p-8",
		id: "projects",
		children: /* @__PURE__ */ jsxs("section", {
			className: "min-h-screen w-screen flex flex-col justify-center items-center p-8 relative",
			children: [
				/* @__PURE__ */ jsx(motion.div, {
				...
				/* @__PURE__ */ jsx("h2", {
					className: "text-2xl font-bold text-[#e34b3a] mb-4",
					children: project.type.toUpperCase()
				}),
				/* @__PURE__ */ jsx("h1", {
					className: "text-4xl md:text-6xl font-bold mb-6 text-[#e34b3a]",
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: project.technologies.map((tech, index) => /* @__PURE__ */ jsx(motion.span, {
				...
				/* @__PURE__ */ jsxs(motion.a, {
					...
					whileTap: { scale: .95 },
					children: ["Learn More", /* @__PURE__ */ jsx(ChevronRight, { className: "ml-2" })]
				})
			]
		})
	});
...
var FeaturedProjects = ({ projects }) => {
	return /* @__PURE__ */ jsxs("section", {
		className: "flex !w-[100vw] bg-[#201d1b] text-[#ecc7bc] overflow-hidden",
		children: [/* @__PURE__ */ jsx("h2", {
			className: "text-4xl font-bold absolute top-8 left-8 z-10",
...
//#endregion
//#region src/components/homepage/components/SkillsProject.jsx
var SkillsProject = ({ skills }) => {
	return /* @__PURE__ */ jsx("div", {
		className: " h-full max-w-[1330px] mx-auto",
		children: /* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("h2", {
				...
				children: skills.map((skill, index) => /* @__PURE__ */ jsx(motion.div, {
					...
					children: /* @__PURE__ */ jsx("span", {
						className: "text-xl font-semibold text-[#ecc7bc]",
						children: skill
					})
				}, index))
			})]
...
//#endregion
//#region src/components/homepage/components/BlogPosts.jsx
	...
	return /* @__PURE__ */ jsx(motion.div, {
		...
		children: /* @__PURE__ */ jsx("a", {
			...
			children: /* @__PURE__ */ jsxs(Card, {
				className: "bg-[#2c2824] border-gray-700 cursor-pointer h-full flex flex-col",
				children: [
					...
					/* @__PURE__ */ jsx(CardFooter, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Avatar, {
								className: "h-8 w-8 mr-2 bg-[#3d3731] text-[#000]",
...
var TypewriterText = ({ text }) => {
	return /* @__PURE__ */ jsx(motion.span, {
		className: "text-sm text-gray-300 inline-block",
		initial: { width: 0 },
		whileInView: { width: "auto" },
		viewport: { once: true },
		children: text.split("").map((char, index) => /* @__PURE__ */ jsx(motion.span, {
			initial: { opacity: 0 },
			animate: { opacity: 1 },
			transition: { delay: index * .1 },
			children: char
...
var BlogPosts = ({ blogPosts = [] }) => {
	return /* @__PURE__ */ jsxs("div", {
		id: "blog",
		className: "bg-[#201d1b] max-w-[1330px] mx-auto text-gray-100 p-4 sm:p-6 md:p-8",
		children: [
			/* @__PURE__ */ jsx("h2", {
			...
			/* @__PURE__ */ jsx("p", {
				...
				children: "Discover insightful resources and expert advice from me."
			}),
			/* @__PURE__ */ jsx("div", {
				className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6",
				children: blogPosts.slice(0, 3).map((blog) => /* @__PURE__ */ jsx(BlogPost, { blog }, blog._id))
			}),
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(motion.a, {
					...
					whileHover: { scale: 1.05 },
					whileTap: { scale: .95 },
					children: ["All Blogs", /* @__PURE__ */ jsx(ChevronRight, { className: "ml-2" })]
				})
			})
		]
	});
...
var $$Index = createComponent(async ($$result, $$props, $$slots) => {
	const mongoClient = new MongoClient("mongodb+srv://slu:clCFKVSqqzbGBdhx@blogcluster.xdgyh.mongodb.net/?retryWrites=true&w=majority&appName=BlogCluster");
	let blogPosts = [];
	try {
		await mongoClient.connect();
		const posts = await mongoClient.db("blogDatabase").collection("posts").find({}).sort({ createdAt: -1 }).toArray();
	...
	}, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<main class=" bg-[#201d1b] w-full overflow-hidden text-[#ecc7bc]" data-astro-cid-lcdefpme><div data-astro-cid-lcdefpme>${renderComponent($$result2, "HeroPage", HeroSection, {
		"client:load": true,
		"data-astro-cid-lcdefpme": true,
		"client:component-hydration": "load",
		"client:component-path": "@/components/homepage/components/HeroPage",
		"client:component-export": "default"
	})}</div><div class="my_container " data-astro-cid-lcdefpme>${renderComponent($$result2, "FeaturedProjects", FeaturedProjects, {
		"client:load": true,
		"projects": projects,
		"data-astro-cid-lcdefpme": true,
		"client:component-hydration": "load",
		"client:component-path": "@/components/homepage/components/FeaturedProjects",
		"client:component-export": "default"
	})}</div><div data-astro-cid-lcdefpme>${renderComponent($$result2, "BlogPosts", BlogPosts, {
		"blogPosts": blogPosts,
		"client:load": true,
		"data-astro-cid-lcdefpme": true,
		"client:component-hydration": "load",
		"client:component-path": "@/components/homepage/components/BlogPosts",
		"client:component-export": "default"
	})}</div><div data-astro-cid-lcdefpme>${renderComponent($$result2, "SkillsProject", SkillsProject, {
		"skills": skills,
		"client:load": true,
		"data-astro-cid-lcdefpme": true,
		"client:component-hydration": "load",
		"client:component-path": "@/components/homepage/components/SkillsProject",
		"client:component-export": "default"
	})}</div></main>` })}<script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/gsap.min.js"><\/script><script src="https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/ScrollTrigger.min.js"><\/script><script>
...
var $$file = "/Users/slu/Public/code folders/personal_code/portfolio-v1/src/pages/index.astro";
//#endregion
