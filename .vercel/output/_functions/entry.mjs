import { D as MiddlewareNotAResponse, E as MiddlewareNoDataOrNextCalled, G as StaticClientAddressNotAvailable, T as LocalsReassigned, U as ResponseSentError, X as AstroError, Y as i18nNoLocaleFoundInPath, a as ClientAddressNotAvailable, i as CacheNotEnabled, n as ActionsReturnedInvalidDataError, p as ForbiddenRewrite, r as AstroResponseHeadersReassigned, t as ActionNotFoundError, w as LocalsNotAnObject, z as PrerenderClientAddressNotAvailable } from "./chunks/errors-data_BJ4JQ9fH.mjs";
import { a as matchPattern } from "./chunks/remoteProbe_pctxpEg4.mjs";
...
var middlewareSecret = "2c89ecc0-3862-48bc-891b-bef03347b6e9";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/slu/Public/code folders/personal_code/portfolio-v1/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/slu/Public/code folders/personal_code/portfolio-v1/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/upload-blog",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/upload-blog\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/api/upload-blog.js",
			"pathname": "/api/upload-blog",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/blogs.astro",
			"pathname": "/blogs",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_CnsH8EYG.mjs");
var _page1 = () => import("./chunks/index_Dlg-Kfkd.mjs");
var _page2 = () => import("./chunks/upload-blog_DMklLOMn.mjs");
var _page3 = () => import("./chunks/_slug__M0EEItqC.mjs");
var _page4 = () => import("./chunks/blogs_C0cA1bSo.mjs");
var _page5 = () => import("./chunks/index_BOzbokTO.mjs");
...
var _manifest = deserializeManifest({"rootDir":"file:///Users/slu/Public/code%20folders/personal_code/portfolio-v1/","cacheDir":"file:///Users/slu/Public/code%20folders/personal_code/portfolio-v1/node_modules/.astro/","outDir":"file:///Users/slu/Public/code%20folders/personal_code/portfolio-v1/dist/","srcDir":"file:///Users/slu/Public/code%20folders/personal_code/portfolio-v1/src/","publicDir":"file:///Users/slu/Public/code%20folders/personal_code/portfolio-v1/public/","buildClientDir":"file:///Users/slu/Public/code%20folders/personal_code/portfolio-v1/dist/client/","buildServerDir":"file:///Users/slu/Public/code%20folders/personal_code/portfolio-v1/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.DJ1T1J6G.js"}],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.DJ1T1J6G.js"}],"styles":[{"type":"external","src":"_astro/_astro_transitions.BP2g7Cw8.css"},{"type":"inline","content":"body{margin:0%;padding:0%;font-family:Plus Jakarta Sans Variable,sans-serif}.preloader{z-index:9999;background:#201d1b;justify-content:center;align-items:center;transition:opacity .6s,visibility .6s;display:flex;position:fixed;inset:0}.preloader.hidden{opacity:0;visibility:hidden;pointer-events:none}.kitchen{flex-direction:column;align-items:center;gap:2rem;display:flex}.pot-wrap{width:120px;height:140px;position:relative}.pot{position:absolute;bottom:24px;left:50%;transform:translate(-50%)}.pot-body{background:linear-gradient(#4a4a4a 0%,#2a2a2a 100%);border-top:4px solid #666;border-radius:0 0 16px 16px;width:80px;height:52px;position:relative;overflow:hidden}.pot-body:before{content:\"\";background:linear-gradient(#e34b3a 0%,#c0392b 60%,#8b2a1e 100%);border-radius:0 0 12px 12px;position:absolute;inset:0 4px 8px}.pot-handle-left,.pot-handle-right{border:3px solid #666;border-bottom:none;border-radius:6px 6px 0 0;width:14px;height:10px;position:absolute;top:4px}.pot-handle-left{left:-16px}.pot-handle-right{right:-16px}.bubble{z-index:2;background:#ffffff4d;border-radius:50%;width:6px;height:6px;position:absolute}.bubble-1{animation:1.2s ease-in infinite bubbleUp;bottom:10px;left:18px}.bubble-2{animation:1.5s ease-in .3s infinite bubbleUp;bottom:8px;left:38px}.bubble-3{width:4px;height:4px;animation:1s ease-in .6s infinite bubbleUp;bottom:12px;left:55px}.bubble-4{width:5px;height:5px;animation:1.8s ease-in .9s infinite bubbleUp;bottom:6px;left:28px}@keyframes bubbleUp{0%{opacity:.6;transform:translateY(0)scale(1)}50%{opacity:.8}to{opacity:0;transform:translateY(-35px)scale(.3)}}.steam-container{width:60px;height:50px;position:absolute;top:10px;left:50%;transform:translate(-50%)}.steam{filter:blur(4px);background:#ecc7bc14;border-radius:50%;width:8px;height:20px;position:absolute;bottom:0}.steam-1{animation:2s ease-out infinite steamRise;left:10px}.steam-2{animation:2.3s ease-out .4s infinite steamRise;left:26px}.steam-3{animation:1.8s ease-out .8s infinite steamRise;left:42px}@keyframes steamRise{0%{opacity:0;transform:translateY(0)scaleX(1)}15%{opacity:.5}50%{opacity:.3;transform:translateY(-30px)scaleX(1.8)}to{opacity:0;transform:translateY(-55px)scaleX(2.5)}}.spoon{transform-origin:bottom;background:linear-gradient(#ccc 0%,#888 100%);border-radius:2px;width:4px;height:50px;animation:1.5s ease-in-out infinite stir;position:absolute;bottom:40px;left:50%}.spoon:after{content:\"\";background:#999;border-radius:0 0 6px 6px;width:12px;height:8px;position:absolute;bottom:-6px;left:50%;transform:translate(-50%)}@keyframes stir{0%,to{transform:rotate(-15deg)}50%{transform:rotate(15deg)}}.flame-container{gap:6px;display:flex;position:absolute;bottom:0;left:50%;transform:translate(-50%)}.flame{background:linear-gradient(#ffbe0b 0%,#e34b3a 60%,#c0392b 100%);border-radius:50%/60% 60% 40% 40%;width:10px;height:16px;animation:.4s ease-in-out infinite alternate flicker}.flame-1{height:14px;animation-delay:0s}.flame-2{height:18px;animation-delay:.15s}.flame-3{height:12px;animation-delay:.3s}@keyframes flicker{0%{opacity:.9;transform:scaleY(1)scaleX(1)}to{opacity:1;transform:scaleY(1.15)scaleX(.85)}}.loader-text{color:#ecc7bc;letter-spacing:.15em;text-transform:uppercase;opacity:.7;font-size:.95rem}.dots:after{content:\"\";animation:1.5s steps(3,end) infinite dotAnim}@keyframes dotAnim{0%{content:\"\"}33%{content:\".\"}66%{content:\"..\"}to{content:\"...\"}}\n"},{"type":"external","src":"_astro/minimal-tiptap.C44kf7rB.css"}],"routeData":{"route":"/admin","isIndex":true,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/index.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.DJ1T1J6G.js"}],"styles":[],"routeData":{"route":"/api/upload-blog","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/upload-blog\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"upload-blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/upload-blog.js","pathname":"/api/upload-blog","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.DJ1T1J6G.js"}],"styles":[{"type":"external","src":"_astro/_astro_transitions.BP2g7Cw8.css"}],"routeData":{"route":"/blogs/[slug]","isIndex":false,"type":"page","pattern":"^\\/blogs\\/([^/]+?)\\/?$","segments":[[{"content":"blogs","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/blogs/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.DJ1T1J6G.js"}],"styles":[{"type":"external","src":"_astro/_astro_transitions.BP2g7Cw8.css"},{"type":"inline","content":"body{margin:0%;padding:0%;font-family:Plus Jakarta Sans Variable,sans-serif}.preloader{z-index:9999;background:#201d1b;justify-content:center;align-items:center;transition:opacity .6s,visibility .6s;display:flex;position:fixed;inset:0}.preloader.hidden{opacity:0;visibility:hidden;pointer-events:none}.kitchen{flex-direction:column;align-items:center;gap:2rem;display:flex}.pot-wrap{width:120px;height:140px;position:relative}.pot{position:absolute;bottom:24px;left:50%;transform:translate(-50%)}.pot-body{background:linear-gradient(#4a4a4a 0%,#2a2a2a 100%);border-top:4px solid #666;border-radius:0 0 16px 16px;width:80px;height:52px;position:relative;overflow:hidden}.pot-body:before{content:\"\";background:linear-gradient(#e34b3a 0%,#c0392b 60%,#8b2a1e 100%);border-radius:0 0 12px 12px;position:absolute;inset:0 4px 8px}.pot-handle-left,.pot-handle-right{border:3px solid #666;border-bottom:none;border-radius:6px 6px 0 0;width:14px;height:10px;position:absolute;top:4px}.pot-handle-left{left:-16px}.pot-handle-right{right:-16px}.bubble{z-index:2;background:#ffffff4d;border-radius:50%;width:6px;height:6px;position:absolute}.bubble-1{animation:1.2s ease-in infinite bubbleUp;bottom:10px;left:18px}.bubble-2{animation:1.5s ease-in .3s infinite bubbleUp;bottom:8px;left:38px}.bubble-3{width:4px;height:4px;animation:1s ease-in .6s infinite bubbleUp;bottom:12px;left:55px}.bubble-4{width:5px;height:5px;animation:1.8s ease-in .9s infinite bubbleUp;bottom:6px;left:28px}@keyframes bubbleUp{0%{opacity:.6;transform:translateY(0)scale(1)}50%{opacity:.8}to{opacity:0;transform:translateY(-35px)scale(.3)}}.steam-container{width:60px;height:50px;position:absolute;top:10px;left:50%;transform:translate(-50%)}.steam{filter:blur(4px);background:#ecc7bc14;border-radius:50%;width:8px;height:20px;position:absolute;bottom:0}.steam-1{animation:2s ease-out infinite steamRise;left:10px}.steam-2{animation:2.3s ease-out .4s infinite steamRise;left:26px}.steam-3{animation:1.8s ease-out .8s infinite steamRise;left:42px}@keyframes steamRise{0%{opacity:0;transform:translateY(0)scaleX(1)}15%{opacity:.5}50%{opacity:.3;transform:translateY(-30px)scaleX(1.8)}to{opacity:0;transform:translateY(-55px)scaleX(2.5)}}.spoon{transform-origin:bottom;background:linear-gradient(#ccc 0%,#888 100%);border-radius:2px;width:4px;height:50px;animation:1.5s ease-in-out infinite stir;position:absolute;bottom:40px;left:50%}.spoon:after{content:\"\";background:#999;border-radius:0 0 6px 6px;width:12px;height:8px;position:absolute;bottom:-6px;left:50%;transform:translate(-50%)}@keyframes stir{0%,to{transform:rotate(-15deg)}50%{transform:rotate(15deg)}}.flame-container{gap:6px;display:flex;position:absolute;bottom:0;left:50%;transform:translate(-50%)}.flame{background:linear-gradient(#ffbe0b 0%,#e34b3a 60%,#c0392b 100%);border-radius:50%/60% 60% 40% 40%;width:10px;height:16px;animation:.4s ease-in-out infinite alternate flicker}.flame-1{height:14px;animation-delay:0s}.flame-2{height:18px;animation-delay:.15s}.flame-3{height:12px;animation-delay:.3s}@keyframes flicker{0%{opacity:.9;transform:scaleY(1)scaleX(1)}to{opacity:1;transform:scaleY(1.15)scaleX(.85)}}.loader-text{color:#ecc7bc;letter-spacing:.15em;text-transform:uppercase;opacity:.7;font-size:.95rem}.dots:after{content:\"\";animation:1.5s steps(3,end) infinite dotAnim}@keyframes dotAnim{0%{content:\"\"}33%{content:\".\"}66%{content:\"..\"}to{content:\"...\"}}\n"}],"routeData":{"route":"/blogs","isIndex":false,"type":"page","pattern":"^\\/blogs\\/?$","segments":[[{"content":"blogs","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/blogs.astro","pathname":"/blogs","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"external","value":"_astro/page.DJ1T1J6G.js"}],"styles":[{"type":"external","src":"_astro/_astro_transitions.BP2g7Cw8.css"},{"type":"inline","content":"body{margin:0%;padding:0%;font-family:Plus Jakarta Sans Variable,sans-serif}.preloader{z-index:9999;background:#201d1b;justify-content:center;align-items:center;transition:opacity .6s,visibility .6s;display:flex;position:fixed;inset:0}.preloader.hidden{opacity:0;visibility:hidden;pointer-events:none}.kitchen{flex-direction:column;align-items:center;gap:2rem;display:flex}.pot-wrap{width:120px;height:140px;position:relative}.pot{position:absolute;bottom:24px;left:50%;transform:translate(-50%)}.pot-body{background:linear-gradient(#4a4a4a 0%,#2a2a2a 100%);border-top:4px solid #666;border-radius:0 0 16px 16px;width:80px;height:52px;position:relative;overflow:hidden}.pot-body:before{content:\"\";background:linear-gradient(#e34b3a 0%,#c0392b 60%,#8b2a1e 100%);border-radius:0 0 12px 12px;position:absolute;inset:0 4px 8px}.pot-handle-left,.pot-handle-right{border:3px solid #666;border-bottom:none;border-radius:6px 6px 0 0;width:14px;height:10px;position:absolute;top:4px}.pot-handle-left{left:-16px}.pot-handle-right{right:-16px}.bubble{z-index:2;background:#ffffff4d;border-radius:50%;width:6px;height:6px;position:absolute}.bubble-1{animation:1.2s ease-in infinite bubbleUp;bottom:10px;left:18px}.bubble-2{animation:1.5s ease-in .3s infinite bubbleUp;bottom:8px;left:38px}.bubble-3{width:4px;height:4px;animation:1s ease-in .6s infinite bubbleUp;bottom:12px;left:55px}.bubble-4{width:5px;height:5px;animation:1.8s ease-in .9s infinite bubbleUp;bottom:6px;left:28px}@keyframes bubbleUp{0%{opacity:.6;transform:translateY(0)scale(1)}50%{opacity:.8}to{opacity:0;transform:translateY(-35px)scale(.3)}}.steam-container{width:60px;height:50px;position:absolute;top:10px;left:50%;transform:translate(-50%)}.steam{filter:blur(4px);background:#ecc7bc14;border-radius:50%;width:8px;height:20px;position:absolute;bottom:0}.steam-1{animation:2s ease-out infinite steamRise;left:10px}.steam-2{animation:2.3s ease-out .4s infinite steamRise;left:26px}.steam-3{animation:1.8s ease-out .8s infinite steamRise;left:42px}@keyframes steamRise{0%{opacity:0;transform:translateY(0)scaleX(1)}15%{opacity:.5}50%{opacity:.3;transform:translateY(-30px)scaleX(1.8)}to{opacity:0;transform:translateY(-55px)scaleX(2.5)}}.spoon{transform-origin:bottom;background:linear-gradient(#ccc 0%,#888 100%);border-radius:2px;width:4px;height:50px;animation:1.5s ease-in-out infinite stir;position:absolute;bottom:40px;left:50%}.spoon:after{content:\"\";background:#999;border-radius:0 0 6px 6px;width:12px;height:8px;position:absolute;bottom:-6px;left:50%;transform:translate(-50%)}@keyframes stir{0%,to{transform:rotate(-15deg)}50%{transform:rotate(15deg)}}.flame-container{gap:6px;display:flex;position:absolute;bottom:0;left:50%;transform:translate(-50%)}.flame{background:linear-gradient(#ffbe0b 0%,#e34b3a 60%,#c0392b 100%);border-radius:50%/60% 60% 40% 40%;width:10px;height:16px;animation:.4s ease-in-out infinite alternate flicker}.flame-1{height:14px;animation-delay:0s}.flame-2{height:18px;animation-delay:.15s}.flame-3{height:12px;animation-delay:.3s}@keyframes flicker{0%{opacity:.9;transform:scaleY(1)scaleX(1)}to{opacity:1;transform:scaleY(1.15)scaleX(.85)}}.loader-text{color:#ecc7bc;letter-spacing:.15em;text-transform:uppercase;opacity:.7;font-size:.95rem}.dots:after{content:\"\";animation:1.5s steps(3,end) infinite dotAnim}@keyframes dotAnim{0%{content:\"\"}33%{content:\".\"}66%{content:\"..\"}to{content:\"...\"}}\nhtml{-webkit-overflow-scrolling:touch;overflow-scrolling:touch;height:100%;overflow-y:scroll}body{height:unset;position:relative;overflow-y:visible}html,body{margin:0;overflow-x:hidden}.my_container[data-astro-cid-lcdefpme]{flex-wrap:nowrap;width:700%;height:100vh;display:flex}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/slu/Public/code folders/personal_code/portfolio-v1/src/pages/admin/index.astro",{"propagation":"none","containsHead":true}],["/Users/slu/Public/code folders/personal_code/portfolio-v1/src/pages/blogs.astro",{"propagation":"none","containsHead":true}],["/Users/slu/Public/code folders/personal_code/portfolio-v1/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/Users/slu/Public/code folders/personal_code/portfolio-v1/src/pages/blogs/[slug].astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.CfBthkDi.mjs","\u0000virtual:astro:middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","/Users/slu/Public/code folders/personal_code/portfolio-v1/node_modules/@astrojs/react/dist/vnode-children.js":"chunks/vnode-children_B6vVcKTz.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/blogs/[slug]@_@astro":"chunks/_slug__M0EEItqC.mjs","\u0000virtual:astro:page:src/pages/blogs@_@astro":"chunks/blogs_C0cA1bSo.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_CnsH8EYG.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_BOzbokTO.mjs","\u0000virtual:astro:page:src/pages/admin/index@_@astro":"chunks/index_Dlg-Kfkd.mjs","/Users/slu/Public/code folders/personal_code/portfolio-v1/src/components/editor/minimal-tiptap/index.ts":"_astro/minimal-tiptap.FLk_oobA.js","/Users/slu/Public/code folders/personal_code/portfolio-v1/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_nhDJx1xF.mjs","\u0000virtual:astro:page:src/pages/api/upload-blog@_@js":"chunks/upload-blog_DMklLOMn.mjs","@/components/blogs/BlogListingPage":"_astro/BlogListingPage.BZLQHaCl.js","@/components/homepage/components/BlogPosts":"_astro/BlogPosts.Czgbsdpv.js","/Users/slu/Public/code folders/personal_code/portfolio-v1/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts":"_astro/ClientRouter.astro_astro_type_script_index_0_lang.CffmsLCh.js","@/components/shared/ContactBar":"_astro/ContactBar.C83m9g3R.js","/Users/slu/Public/code folders/personal_code/portfolio-v1/src/components/blogs/FeaturedBlogPost.jsx":"_astro/FeaturedBlogPost.BYv7SGlX.js","@/components/homepage/components/FeaturedProjects":"_astro/FeaturedProjects.6kK7yEYY.js","@/components/shared/Header":"_astro/Header.aANNC5SA.js","@/components/homepage/components/HeroPage":"_astro/HeroPage.CgW4ffs3.js","@/components/editor/EditorHomepage/RenderIndividualBlog":"_astro/RenderIndividualBlog.BVtdKSGQ.js","@/components/homepage/components/SkillsProject":"_astro/SkillsProject.CaVA2-Hs.js","@/components/editor/EditorHomepage/UploadBlog":"_astro/UploadBlog.CMD0_r5M.js","@astrojs/react/client.js":"_astro/client.BlwIl3pT.js","astro:scripts/page.js":"_astro/page.DJ1T1J6G.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/favicon.jpg","/favicon.svg","/_astro/AnimatePresence.4SqK_eT5.js","/_astro/BlogListingPage.BZLQHaCl.js","/_astro/BlogPosts.Czgbsdpv.js","/_astro/ClientRouter.astro_astro_type_script_index_0_lang.CffmsLCh.js","/_astro/ContactBar.C83m9g3R.js","/_astro/FeaturedBlogPost.BYv7SGlX.js","/_astro/FeaturedProjects.6kK7yEYY.js","/_astro/Header.aANNC5SA.js","/_astro/HeroPage.CgW4ffs3.js","/_astro/RenderIndividualBlog.BVtdKSGQ.js","/_astro/SkillsProject.CaVA2-Hs.js","/_astro/UploadBlog.CMD0_r5M.js","/_astro/badge.PUnViaom.js","/_astro/card.CYuJdXim.js","/_astro/chevron-right.CtnLD3r6.js","/_astro/client.BlwIl3pT.js","/_astro/createLucideIcon.BNPdgbnE.js","/_astro/dialog.Cr9eAzEd.js","/_astro/dist.5Sa4eKcO.js","/_astro/dist.CaJ37xyq.js","/_astro/dist.DQHe_HLf.js","/_astro/jsx-runtime.DtQc8_p0.js","/_astro/minimal-tiptap.C44kf7rB.css","/_astro/minimal-tiptap.FLk_oobA.js","/_astro/page.DJ1T1J6G.js","/_astro/prefetch.Bp81QQqy.js","/_astro/proxy.C2h5SHSh.js","/_astro/react-dom.CNgiDU2k.js","/_astro/react.BHk431b0.js","/_astro/switch.QUsv9s23.js","/_astro/x.C_09rTa8.js","/shared/vitalis1.webp","/shared/vitalis2.webp","/shared/vitalis3.webp","/shared/vitalis4.webp","/_astro/_astro_transitions.BP2g7Cw8.css","/_astro/plus-jakarta-sans-vietnamese-wght-normal.Bnh6xcKr.woff2","/_astro/plus-jakarta-sans-latin-ext-wght-normal.Ch-K9LVU.woff2","/_astro/plus-jakarta-sans-latin-wght-normal.BD2oGHtS.woff2","/_astro/page.DJ1T1J6G.js"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"ZojGUCR5IP6YWkSOKyHCxOXa6tJCjbaD9Eu/2x+/5J4=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "2c89ecc0-3862-48bc-891b-bef03347b6e9") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
